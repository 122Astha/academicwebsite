											...
											<div class="col-md-12">
												<div class="card card-primary">
													<div class="card-header">
														<h3 class="card-title">Manage Siteconfig</h3><a href="{{ route('siteinformation.create') }}"><button class="p-2 rounded btn-primary">Add siteinformation</button></a>
													</div>
														...
														<table id="example1" class="table table-bordered table-striped">
															<thead>
																<tr>
																	<th>S.N.</th>
																	<th>Action</th>
																	<th>siteinformation key</th>
																	<th>siteinformation Details</th>
																	<th>Status</th>
																</tr>
															</thead>
															<tbody>
															@foreach ($siteinformation as $siteinformations)
																	...
																	<tr>
																       ...
																       <td>
																		...
																		<td>{{ $siteinformations->site_key }}</td>
																		<td>{{ $siteinformations->site_details }}</td>
																		<td>{{ $siteinformations->status }}</td>
